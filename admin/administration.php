<?php
// administration.php — show all errors
...
<head>
  <meta charset="UTF-8">
  <title>CoolCarters Admin Dashboard - Administration</title>
  <!-- Google Font -->
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin:0; padding:0; }
    ...
    .controls .add-btn { padding:.5rem 1rem; background: var(--primary); color: #fff; border:none; border-radius:.25rem; cursor:pointer; }
    /* Table */
    ...
    .action-btn { background:none; border:none; cursor:pointer; font-size:1rem; margin-right:.5rem; }
    /* Footer */
...
<body>
  <nav id="sidebar">
    ...
    <a href="administration.php" class="active"><i class="fas fa-cogs"></i>Administration</a>
  </nav>
  <header id="topnav"><div id="toggleBtn"><i class="fas fa-bars"></i></div><h1>Admin Dashboard</h1><div class="user"><i class="fas fa-user-circle"></i> Administrator</div></header>
  <section id="main">
    <div class="section-header">Administration</div>
    <div class="controls">
      <div class="search">
        <input id="searchInput" type="text" placeholder="Search administrators...">
        <i class="fas fa-search"></i>
      </div>
      <button class="add-btn" onclick="location.href='add_admin.php'">Add Admin</button>
    </div>
          ...
          <?php if (!empty($admins)): ?>
            ...
            <tr>
              ...
              <td>
                ...
                <button class="action-btn" title="Deactivate"><i class="fas fa-user-slash"></i></button>
              </td>
            </tr>
            <?php endforeach; ?>
          <?php else: ?>
            <tr><td colspan="6" style="text-align:center; padding:1rem;">No administrators found.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
