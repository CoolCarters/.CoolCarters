...
<head>
  <meta charset="UTF-8">
  <title>CoolCarters Admin Dashboard - Feedbacks</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin:0; padding:0; }
    ...
    th, td { border:1px solid #bbb; padding:.75rem; text-align:left; vertical-align:top; }
...
<body>
  ...
  <nav id="sidebar">
    ...
    <a href="feedbacks.php" class="active"><i class="fas fa-comments"></i>Feedbacks</a>
      ...
      <table>
        ...
        <tbody id="feedbackTable">
          <?php if (!empty($feedbacks)): ?>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <tr><td colspan="6" style="text-align:center; padding:1rem;">No feedback entries.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
