...
<body>
    ...
    <form action="<?php echo $paypalURL; ?>" method="post">
        ...
        <!-- Specify URLs -->
        <input type='hidden' name='cancel_return' value='http://localhost/CoolCarters/.CoolCarters/cancel.php'>
        <input type='hidden' name='return' value='http://localhost/CoolCarters/.CoolCarters/success.php'>
